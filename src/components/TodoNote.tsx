...
const TodoNote: FC<TodoNotesProps> = ({ id, defaultValue, modifyNote, deleteNote }) => {
  ...
  return (
    isEdited ? <div className='w-full flex flex-wrap rounded-b-xl overflow-hidden shadow-2xl text-lg my-8 first:mt-1 shadow-blue-300 transition-all'>
      ...
      : <div className='w-full flex flex-wrap rounded-b-xl overflow-hidden shadow-xl text-lg my-4 first:mt-1'>
