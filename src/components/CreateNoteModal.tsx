  ...
  return (
    <div className='absolute w-screen h-screen bg-gray-600/40 flex justify-center items-center top-0'>
      <section className='bg-white w-[600px] max-[90%]: h-48 p-0 radius rounded-2xl overflow-hidden shadow-lg'>
        <p className='w-[600px] max-[100%]: h-16 text-2xl flex justify-center items-center'>Add note</p>
        <input className='w-[600px] max-[100%]: h-16 text-2xl p-3 box-border bg-gray-200 focus:outline-0' placeholder='Type in your note!' type="text" name="todo" id="todo" onChange={e => setNote(e.target.value)} autoFocus={true} />
